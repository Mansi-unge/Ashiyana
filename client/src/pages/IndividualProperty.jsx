...
const IndividualProperty = () => {
  ...
  useEffect(() => {
    console.log("Property ID:", id); // Ensure this logs the correct ID
    if (!id) {
      ...
      <div className="p-6 bg-gray-50 animate-pulse">
        <div className="flex flex-wrap lg:flex-nowrap gap-6 p-6">
          <div className="w-full lg:w-1/2 flex flex-col justify-between order-1 lg:order-none">
            <div className="w-full lg:h-80 bg-gray-200 rounded-lg mb-6"></div>
            <div className="mb-4">
          ...
          <div className="w-full lg:w-1/2 h-1/2 lg:h-auto flex-shrink-0 overflow-hidden order-2 lg:order-none mt-2">
